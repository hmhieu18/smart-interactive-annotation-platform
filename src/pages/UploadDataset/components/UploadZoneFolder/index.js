...
const acceptedFormats = {
  [DATASET_DATATYPE.IMAGE]: {
    accept: "image/*",
    message: "Drop PNG, JPEG folders to upload.",
  },
  [DATASET_DATATYPE.VIDEO]: {
    accept: "video/*",
    message: "Drop MP4 folders to upload.",
  },
};
...
const UploadZoneFolder = (props) => {
  ...
  const [acceptedFormat, setAcceptedFormat] = useState(
    acceptedFormats[DATASET_DATATYPE.IMAGE]
  );
      ...
      <div className={classes.dropZoneWrapper}>
        {!isUploaded && !isLoading["uploading"] && (
          <div
            ...
            style={{ height: files.length ? 100 : 300 }}
          >
            <input
              {...getInputProps()}
              directory=""
